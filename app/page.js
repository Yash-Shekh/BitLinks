    ...
    <main>
      <section className="grid md:grid-cols-2 h-full">
        <div className="flex flex-col justify-center items-center gap-4">
          ...
          <div className="inline-block md:hidden justify-center items-center relative h-75 w-screen p-2">
            <Image
              alt="An Image of Office" src={"/blue.jpg"} fill={true} />
          </div>

          <div className=" text-lg md:text-xl text-gray-500 text-center">
          ...
          <div className="flex gap-4 my-2">
            <Link href="/short" >
              <button className='bg-blue-700 text-white px-4 py-2 md:px-2 md:py-1 rounded-lg font-bold text-xl'>
                Try Now</button></Link>
            <Link href="/About" >
              <button className='bg-blue-700 text-white px-4 py-2 md:px-2 md:py-1 rounded-lg font-bold text-xl'>
        ...
        <div className="hidden md:inline-block justify-center items-center relative h-[75vh] p-4">
          <Image
            className="pt-10"
            alt="An Image of Office" src={"/blue.jpg"} fill={true} />
        </div>
